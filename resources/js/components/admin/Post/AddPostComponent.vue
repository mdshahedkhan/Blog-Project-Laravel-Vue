            ...
            <div class="card">
                <div class="card-header bg-info">
                    ...
                    <div class="card-tools">
                        <router-link to="/categories" class="btn btn-block btn-info"><i class="fas fa-list"></i> All Posts</router-link>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <form class="form-horizontal" method="post" v-on:submit.prevent="storeData">
                        <div class="card-body col-md-10">
                            <div class="form-group row">
                                <label for="categoryName" class="col-sm-3 col-form-label">Post Name</label>
                                <div class="col-sm-9">
